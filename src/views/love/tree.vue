    ...
    <div id="main">
      ...
      <div id="wrap">
          ...
          <div id="code">
            <font color="black" size="4"
              ><b
                ><i>
                  <span class="say"
                    >不管你能否看的到，但是我还是要把这些心里话说出来！</span
                  ><br />
                  <span class="say"> </span><br />
                  <span class="say"
                    ><span class="ai">对的人 </span
                    >，昨天太近，明天太远。选在今日，对你告白！</span
                  ><br />
                  <span class="say"> </span><br />
                  <span class="say">
                    对你的依赖，如同鱼儿离不开海洋，如同植物离不开阳光。</span
                  ><br />
                  <span class="say"> </span><br />
                  <span class="say">给我一次机会，写满我们的幸福人生。</span
                  ><br />
                  <span class="say"> </span><br />
        ...
        <div id="clock-box">
          <span
            ><font color="#666666"
              ><span class="ai">亲爱的 </span>，我等你已经是</font
            ></span
          >
          <div id="clock"></div>
        </div>
